angular.module('starter.controllers', [])
        ...
        .controller('StationCtrl', function ($scope, $state, Arrivals, BusServices) {
            var busList = BusServices.getBuses();

            var stationName = $state.params.stationName + " station";
            $scope.stationName = stationName;

            $scope.filteredBusList=BusServices.listBusByStation(stationName, busList);
